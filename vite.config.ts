  ...
  vite: {
    define: {
      "import.meta.env.VITE_SUPABASE_URL": JSON.stringify(
        pick("VITE_SUPABASE_URL", "SUPABASE_URL", "URL_SUPABASE"),
      ),
      "import.meta.env.VITE_SUPABASE_ANON_KEY": JSON.stringify(
        pick("VITE_SUPABASE_ANON_KEY", "VITE_SUPABASE_PUBLISHABLE_KEY", "SUPABASE_PUBLISHABLE_KEY", "SUPABASE_ANON_KEY", "ANON_KEY_SUPABASE"),
      ),
      "import.meta.env.VITE_SUPABASE_PUBLISHABLE_KEY": JSON.stringify(
        pick("VITE_SUPABASE_PUBLISHABLE_KEY", "SUPABASE_PUBLISHABLE_KEY", "VITE_SUPABASE_ANON_KEY", "SUPABASE_ANON_KEY", "ANON_KEY_SUPABASE"),
      ),
