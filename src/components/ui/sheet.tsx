...
const sheetVariants = cva(
  "fixed z-50 gap-3 bg-background shadow-2xl transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
  {
    variants: {
      side: {
        ...
        right:
          "left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100vw-1rem)] max-w-md max-h-[calc(100dvh-var(--bottomnav-height)-1.5rem)] md:max-h-[calc(100dvh-2rem)] overflow-y-auto rounded-2xl border border-border p-3.5 text-sm data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
      },
    },
    defaultVariants: {
      side: "right",
