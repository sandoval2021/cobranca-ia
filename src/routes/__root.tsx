...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Cobrança IA" },
      { title: "Painel de Cobrança IA" },
      { name: "description", content: "Gerencie clientes, cobranças, testes e mensagens em um só lugar." },
      { property: "og:title", content: "Painel de Cobrança IA" },
      { property: "og:description", content: "Gerencie clientes, cobranças, testes e mensagens em um só lugar." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Painel de Cobrança IA" },
      { name: "twitter:description", content: "Gerencie clientes, cobranças, testes e mensagens em um só lugar." },
